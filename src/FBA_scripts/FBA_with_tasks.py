...
def main():
    ...
    for tissue in tissue_list:
        ...
        results[['sample_ids', 'gene_ids', 'solution', 'tasks_results']].to_csv(path_or_buf='C:/Users/Sigve/Genome_Data/results/ind_results/extensive/ind_{0}.tsv'.format(tissue), sep='\t')
