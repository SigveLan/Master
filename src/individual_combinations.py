...
def main():
    ...
    output_file = 'C:/Users/Sigve/Genome_Data/results/ind_combinations/all_missense_comb.tsv'
    ...
    for column in ind_data:
        ...
        res_dict[column] = [';'.join(ind_data['variant_name'][ind_data[column] > 1].to_list()), ';'.join(set([i[:-3] for i in ind_data['gene_id'][ind_data[column] > 1].to_list()]))]
