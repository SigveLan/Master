...
def main():
    ...
    tissue_list = ['liver']#, 'spleen', 'adipose_tissue', 'adrenal_gland', 'pituitary', 'thyroid', 'blood', 'brain', 'heart', 'kidney', 'liver', 'muscle', 'nerve', 'lung']

    for tissue in tissue_list:

        fba_filter_res = pd.read_table('C:/Users/Sigve/Genome_Data/results/ind_results/filtered/ind_all_homozygote_{0}_f.tsv'.format(tissue), index_col=0)
